...
const channels = [
  ...
  },
  {
    ...
    title: "Facebook",
    description:
      "Our Facebook community brings together Austin's food lovers to trade recommendations and hear about new spots — a trusted channel for word-of-mouth reach.",
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
